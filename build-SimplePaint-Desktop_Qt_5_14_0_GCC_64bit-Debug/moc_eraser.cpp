...
#include <memory>
#include "../SimplePaint/headers/eraser.h"
...
struct qt_meta_stringdata_Eraser_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Eraser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Eraser_t qt_meta_stringdata_Eraser = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Eraser"
...
static const uint qt_meta_data_Eraser[] = {
...
QT_INIT_METAOBJECT const QMetaObject Eraser::staticMetaObject = { {
    QMetaObject::SuperData::link<Tool::staticMetaObject>(),
    qt_meta_stringdata_Eraser.data,
    qt_meta_data_Eraser,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Eraser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Eraser.stringdata0))
